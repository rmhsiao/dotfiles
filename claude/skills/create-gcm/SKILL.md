...
Follow Conventional Commits format for commit messages. Allowed types are listed below. Add a scope if needed.
...
3. If a scope is needed, ask the developer or determine it from previous commits in the same branch.
